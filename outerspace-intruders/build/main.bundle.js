...
var _assetManager = __webpack_require__(337);

var _assetManager2 = _interopRequireDefault(_assetManager);

var _inputManager = __webpack_require__(340);

var _inputManager2 = _interopRequireDefault(_inputManager);

var _entitiesManager = __webpack_require__(341);
...
var _tagManager = __webpack_require__(95);

var _tagManager2 = _interopRequireDefault(_tagManager);

var _engine = __webpack_require__(43);
...
var BoundingBox = function (_Rectangle) {
  ...
  function BoundingBox() {
    var position = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new _vector2.default();
    var sizes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new _vector2.default();

    _classCallCheck(this, BoundingBox);

    var _this = _possibleConstructorReturn(this, (BoundingBox.__proto__ || Object.getPrototypeOf(BoundingBox)).call(this, position, sizes));

    _this._tagManager = new _tagManager2.default();
    _this._color = '#00ff00';
    return _this;
  }
  ...
  _createClass(BoundingBox, [{
    ...
    value: function contains(rectangle) {
      ...
      try {
        for (var _iterator = rectangle.points[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    key: "render",
    value: function render(deltaTime) {
      _engine.engine.canvasContext.strokeStyle = this._color;
      _engine.engine.canvasContext.strokeRect(this.leftTopCorner.x, this.leftTopCorner.y, this.width, this.height);
    }
  }, {
    key: "intersect",
    value: function intersect(boundingBox) {
      var _iteratorNormalCompletion2 = true;
      var _didIteratorError2 = false;
      var _iteratorError2 = undefined;

      try {
        for (var _iterator2 = boundingBox.points[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    key: "onCollision",
    value: function onCollision(boundingBox) {}
  }, {
    key: "tagManager",
    get: function get() {
...
var Rectangle = function () {
  ...
  _createClass(Rectangle, [{
    ...
    key: "rightTopCorner",
    get: function get() {
      return new _vector2.default(this.maxX, this.minY);
    }
  }, {
    key: "leftBottomCorner",
    get: function get() {
      return new _vector2.default(this.minX, this.maxY);
    }
  }, {
    key: "rightBottomCorner",
    get: function get() {
      return new _vector2.default(this.maxX, this.maxY);
    }
  }, {
    key: "center",
    get: function get() {
      return new _vector2.default.add(this.leftTopCorner, this.halfSizes);
    }
  }, {
    key: "points",
    get: function get() {
      var points = [this.leftTopCorner.clone(), this.rightTopCorner.clone(), this.rightBottomCorner.clone(), this.leftBottomCorner.clone()];
      return points;
    }
  }]);
...
var TagManager = function () {
  ...
  _createClass(TagManager, [{
    key: "add",
    value: function add(tag, value) {
      this._tags.set(tag, value);
    }
  }, {
    key: "valueOf",
    value: function valueOf(tag) {
...
var Entity = function () {
  function Entity() {
    ...
    this._tagManager = new _tagManager2.default();
...
var _boundingBox2 = __webpack_require__(51);
...
var Projectile = function (_Entity) {
  ...
  function Projectile() {
    ...
    _this._boundingBox = new _boundingBox3.default();
    _this._canvasContext = null;
    _this._sprite = null;

    _this._boundingBox.onCollision = _this._onCollision.bind(_this);
    return _this;
  }
  ...
  _createClass(Projectile, [{
    key: "update",
    value: function update(deltaTime) {
      this._boundingBox.position.add(_vector2.default.multiply(this._velocity, this._speed));
    ...
    key: "_onCollision",
    value: function _onCollision(boundingBox) {
      if (boundingBox.tagManager.valueOf("entityType") === "enemy") {
        console.log("COLLISION666!!!");
        this.isActive = false;
        _engine.engine.entitiesManager.removeFromGroup(this, "player_projectiles");
      }
    }
  }, {
    key: "position",
...
var _quadtree = __webpack_require__(342);

var _quadtree2 = _interopRequireDefault(_quadtree);

var _player = __webpack_require__(343);

var _player2 = _interopRequireDefault(_player);

var _enemiesManager = __webpack_require__(345);

var _enemiesManager2 = _interopRequireDefault(_enemiesManager);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var player = void 0;
var enemiesManager = void 0;
var quadtree = void 0;
...
function init() {
  ...
  player.position = new _vector2.default(295, 750);
  player.boundingBox = new _boundingBox2.default(new _vector2.default(395, 550), new _vector2.default(10, 15));
  ...
  enemiesManager = new _enemiesManager2.default();
  enemiesManager.createEnemies();

  var enemies = this.entitiesManager.getGroup('enemies');

  var position = new _vector2.default();
  var sizes = new _vector2.default(_engine.engine.canvasWidth, _engine.engine.canvasHeight);
  var area = new _rectangle2.default(position, sizes);
  quadtree = new _quadtree2.default(area, 0);
}
...
function updateQuadtree(deltaTime) {
  var enemies = _engine.engine.entitiesManager.getGroup('enemies');
  var playerProjectiles = _engine.engine.entitiesManager.getGroup('player_projectiles');
  quadtree.clear();
  ...
  if (playerProjectiles !== undefined) {
    for (var _i = 0; _i < playerProjectiles.length; _i++) {

      quadtree.insert(playerProjectiles[_i].boundingBox);
    }
  }
...
function handleCollisions(deltaTime) {
  ...
  if (playerProjectiles !== undefined) {
    ...
    try {
      for (var _iterator2 = playerProjectiles[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        var playerProjectile = _step2.value;

        var returnObjects = quadtree.retrieve(playerProjectile.boundingBox);
        var _iteratorNormalCompletion3 = true;
        var _didIteratorError3 = false;
        var _iteratorError3 = undefined;

        try {
          for (var _iterator3 = returnObjects[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
function render(deltaTime) {
  ...
  try {
    for (var _iterator4 = this._entitiesManager.entities.values()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
var _imageLoader = __webpack_require__(338);

var _imageLoader2 = _interopRequireDefault(_imageLoader);

var _jsonLoader = __webpack_require__(339);
...
var Quadtree = function () {
  function Quadtree() {
    var area = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new _rectangle2.default();
  ...
  _createClass(Quadtree, [{
    ...
    key: "insert",
    value: function insert(boundingBox) {
      if (this._nodes.length > 0) {
        var index = this._getIndexNode(boundingBox);
        if (index !== -1) {
          this._nodes[index].insert(boundingBox);
        }
      } else {
        this._objects.push(boundingBox);
        if (this._objects.length > MAX_OBJECTS_PER_NODE && this._level < MAX_LEVEL) {
          if (this._nodes.length === 0) {
            this._split();
          }
          for (var i = 0; i < this._objects.length; i++) {
            var _index = this._getIndexNode(this._objects[i]);
            if (_index !== -1) {
              this._nodes[_index].insert(this._objects[i]);
    ...
    key: "retrieve",
    value: function retrieve(boundingBox) {
      var index = this._getIndexNode(boundingBox);
      var objects = null;
      if (index !== -1 && this._nodes.length > 0) {
    ...
    value: function _split() {
      ...
      var halfSizes = this._area.halfSizes;
      ...
      * ─────────  *  ───────── *
      ***************************/
      var areaNodeA = new _rectangle2.default(this._area.leftTopCorner.clone(), halfSizes.clone());
      var areaNodeB = new _rectangle2.default(new _vector2.default(this._area.center.x, this._area.minY), halfSizes.clone());
      var areaNodeC = new _rectangle2.default(new _vector2.default(this._area.minX, this._area.center.y), halfSizes.clone());

      var areaNodeD = new _rectangle2.default(this._area.center, halfSizes.clone());
    ...
    key: "_getIndexNode",
    value: function _getIndexNode(boundingBox) {
      var index = PARENT;
    ...
    key: "render",
    value: function render(deltaTime) {
      _engine.engine.canvasContext.strokeStyle = '#FF0000';
      _engine.engine.canvasContext.strokeRect(this._area.leftTopCorner.x, this._area.leftTopCorner.y, this._area.width, this._area.height);
...
var _projectile = __webpack_require__(133);
...
var _objectsPool = __webpack_require__(344);

var _objectsPool2 = _interopRequireDefault(_objectsPool);
...
var SPEED = new _vector2.default(0, 2);
...
var Player = function (_Entity) {
  ...
  function Player() {
    ...
    _this._projectilesPool = new _objectsPool2.default(_projectile2.default, 10);
    return _this;
  }
  ...
  _createClass(Player, [{
    ...
    value: function _createProjectile() {
      var projectile = this._projectilesPool.getObject();
      ...
      projectile.boundingBox.sizes.copy(new _vector2.default(3, 9));
...
var ObjectsPool = function () {
  function ObjectsPool(objectType) {
    var initialSize = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

    _classCallCheck(this, ObjectsPool);
...
var _enemy = __webpack_require__(346);
...
var _marked = /*#__PURE__*/regeneratorRuntime.mark(moveDown);
...
var GAP = 30;
var STARTING_POSITION = new _vector2.default(10, 10);
var ENDING_POSITION = new _vector2.default(780, 10);
var MIN_X = STARTING_POSITION.x;
var MAX_X = STARTING_POSITION.x;
var SPEED = new _vector2.default(50, 50);

function moveDown(deltaTime) {
  var y, finalY, velocity, speed;
  return regeneratorRuntime.wrap(function moveDown$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          y = 0, finalY = 40;
          velocity = DOWN.clone(), speed = SPEED.clone();
        ...
        case 11:
          ...
          _context.t3 = _context.t1.scaled.call(_context.t1, _context.t2);
          y += _context.t0.add.call(_context.t0, _context.t3).y;
          _context.next = 6;
          break;
...
var EnemiesManager = function () {
  function EnemiesManager() {
    ...
    this._previousVelocity = new _vector2.default();
  ...
  _createClass(EnemiesManager, [{
    ...
    value: function createEnemies() {
      for (var row = 0; row < ROWS; row++) {
        ...
        for (var column = 0; column < COLUMNS; column++) {
          var enemy = this._createEnemy(row, column);
          enemy.tagManager.add('row', row);
          enemy.tagManager.add('entityType', 'enemy');
          this._enemies.get("row_" + row).set(enemy.name, enemy);
          _engine.engine.entitiesManager.addAtGroup(enemy, "enemies");
        }
      }
    }
  }, {
    key: "_createEnemy",
    value: function _createEnemy(row, column) {
      var enemy = new _enemy2.default();

      var x = STARTING_POSITION.x + column * GAP;
      var y = STARTING_POSITION.y + row * GAP;
      var position = new _vector2.default(x, y);

      enemy.boundingBox = new _boundingBox2.default(position, new _vector2.default(14, 15));
      ...
      enemy.canvasContext = _engine.engine.canvasContext;
      enemy.sprite = _engine.engine.assetManager.assets.get("enemy");
    ...
    value: function update(deltaTime) {
      for (var row = 0; row < ROWS; row++) {
        var enemiesOfTheRow = Array.from(this._enemies.get("row_" + row).values());
    ...
    key: "_shouldMoveDown",
    value: function _shouldMoveDown(enemies) {
      var firstEnemy = enemies[0];
      var lastEnemy = enemies[enemies.length - 1];

      if ((firstEnemy.position.x < STARTING_POSITION.x && firstEnemy._velocity.x === LEFT.x || lastEnemy.position.x > ENDING_POSITION.x && lastEnemy._velocity.x === RIGHT.x) && this._moveFormationDown === false) {
        return true;
      }
      return false;
    }
  }, {
    key: "_setGlobalVelocity",
    value: function _setGlobalVelocity(velocity) {
      for (var row = 0; row < ROWS; row++) {
        var enemiesOfTheRow = Array.from(this._enemies.get("row_" + row).values());
        for (var index = 0; index < enemiesOfTheRow.length; index++) {
...
exports.default = EnemiesManager;
